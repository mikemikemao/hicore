...
#define ENGINESDIR "/usr/local/jenkins/workspace/AVI-COMMON-CCI-Pipeline-New/2762/install/A2/lib/engines"
#define OPENSSLDIR "/usr/local/jenkins/workspace/AVI-COMMON-CCI-Pipeline-New/2762/install/A2/ssl"
#endif
#endif
