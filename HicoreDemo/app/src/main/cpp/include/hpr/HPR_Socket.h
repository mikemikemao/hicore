...
#else
HPR_DECLARE HPR_INT32 CALLBACK HPR_CloseSocket(HPR_SOCK_T iSockFd, HPR_BOOL bForce);
#endif
...
/**
 * Function:    HPR_Bind_ToDevice
 * Desc:
 * Input:
 * Output:
 * Return:      if success return HPR_OK, otherwise return HPR_ERROR.
 * */
HPR_DECLARE HPR_INT32 CALLBACK HPR_Bind_ToDevice(HPR_SOCK_T iSockFd, const HPR_INT8* pIfName);

HPR_DECLARE HPR_INT32 CALLBACK HPR_SetMultiCastLoopV6(HPR_SOCK_T iSockFd, HPR_BOOL bYesNo);

HPR_DECLARE HPR_INT32 CALLBACK HPR_SetMultiCastHopsV6(HPR_SOCK_T iSockFd, HPR_INT32 flag);

HPR_DECLARE HPR_INT32 CALLBACK HPR_SetTCP_KeepAlive(HPR_SOCK_T iSockFd, HPR_BOOL bYesNo, HPR_UINT32 maxTime);
